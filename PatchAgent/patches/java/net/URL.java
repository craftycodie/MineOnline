...
import gg.codie.mineonline.patchagent.Globals;
...
public final class URL implements java.io.Serializable {
            ...
            throws MalformedURLException
    {
        if(spec.startsWith("http"))
            System.out.println("New URL: " + spec);

        String[] redirectedDomains = new String[] {
                "www.minecraft.net:-1",
                "skins.minecraft.net",
        ...
        for (String redirectedDomain : redirectedDomains) {
            spec = spec.replace(redirectedDomain, Globals.API_HOSTNAME);
        }

        spec = spec.replace("https", "http");

        if(spec.startsWith("http"))
            System.out.println("Transformed URL: " + spec);
