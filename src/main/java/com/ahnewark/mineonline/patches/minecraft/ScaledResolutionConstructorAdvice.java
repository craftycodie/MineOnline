...
public class ScaledResolutionConstructorAdvice {
    ...
    static void intercept(@Advice.This Object thisObj) {
        try {
            int guiScale = (int) ClassLoader.getSystemClassLoader().loadClass("com.ahnewark.mineonline.patches.minecraft.ScaledResolutionConstructorAdvice").getField("guiScale").get(null);
