...
public class ChannelLWJGLOpenALPreLoadBuffersAdvice {
    ...
    static void intercept(
        ...
        try {
            ByteBuffer bufferBuffer = (ByteBuffer) ClassLoader.getSystemClassLoader().loadClass("com.ahnewark.mineonline.patches.paulscode.PaulscodePatch").getField("bufferBuffer").get(null);
