        ...
        try {
            ...
            if (!(boolean)ClassLoader.getSystemClassLoader().loadClass("com.ahnewark.mineonline.patches.lwjgl.LWJGLDisplayUpdateAdvice").getField("inUpdateHook").get(null)) {
                ...
                if ((boolean)ClassLoader.getSystemClassLoader().loadClass("com.ahnewark.mineonline.patches.minecraft.InputPatch").getField("enableClassicFixes").get(null))
                    return !(boolean)ClassLoader.getSystemClassLoader().loadClass("com.ahnewark.mineonline.gui.input.MouseHandler").getMethod("isButtonDown", int.class).invoke(null, button)
                        || (
                                !(boolean)ClassLoader.getSystemClassLoader().loadClass("com.ahnewark.mineonline.gui.input.MouseHandler").getMethod("didClickCooldown", int.class, long.class).invoke(null, button, 250L)
