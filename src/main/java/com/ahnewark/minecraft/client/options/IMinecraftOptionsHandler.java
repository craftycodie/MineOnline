...
public interface IMinecraftOptionsHandler {
    ...
    float getGamma() throws NoSuchFieldException;

    void setGamma(float gamma);

    boolean getClouds() throws NoSuchFieldException;

    void setClouds(boolean clouds);

    boolean getServerTextures() throws NoSuchFieldException;

    void setServerTextures(boolean serverTextures);

    EMinecraftParticles getParticles() throws NoSuchFieldException;

    void setParticles(EMinecraftParticles particles);

    String getLanguage() throws NoSuchFieldException;

    void setLanguage(String language);

    boolean getChatColors() throws NoSuchFieldException;

    void setChatColors(boolean chatColors);

    boolean getChatLinks() throws NoSuchFieldException;

    void setChatLinks(boolean chatLinks);

    boolean getChatLinksPrompt() throws NoSuchFieldException;

    void setChatLinksPrompt(boolean chatLinksPrompt);

    boolean getSnooperEnabled() throws NoSuchFieldException;

    void setSnooperEnabled(boolean snooperEnabled);

    boolean getVsync() throws NoSuchFieldException;

    void setVsync(boolean enableVsync);

    boolean getHideServerAddress() throws NoSuchFieldException;

    void setHideServerAddress(boolean hideServerAddress);

    boolean getAdvancedItemTooltips() throws NoSuchFieldException;

    void setAdvancedItemTooltips(boolean advancedItemTooltips);

    boolean getPauseOnLostFocus() throws NoSuchFieldException;

    void setPauseOnLostFocus(boolean pauseOnLostFocus);

    boolean getShowCape() throws NoSuchFieldException;

    void setShowCape(boolean showCape);

    boolean getTouchscreen() throws NoSuchFieldException;

    void setTouchscreen(boolean touchscreen);

    boolean getHeldItemTooltips() throws NoSuchFieldException;

    void setHeldItemTooltips(boolean heldItemTooltips);

    EMinecraftChatVisibility getChatVisibility() throws NoSuchFieldException;

    void setChatVisibility(EMinecraftChatVisibility chatVisibility);

    float getChatHeightFocused() throws NoSuchFieldException;

    void setChatHeightFocused(float chatHeightFocused);

    float getChatHeightUnfocused() throws NoSuchFieldException;

    void setChatHeightUnfocused(float chatHeightUnfocused);

    float getChatScale() throws NoSuchFieldException;

    void setChatScale(float chatScale);

    float getChatWidth() throws NoSuchFieldException;

    void setChatWidth(float chatWidth);

    void setAttackKey(int keyCode);

    int getAttackKey() throws NoSuchFieldException;

    void setUseKey(int keyCode);

    int getUseKey() throws NoSuchFieldException;

    float getChatOpacity() throws NoSuchFieldException;

    void setChatOpacity(float chatOpacity);

    void setPickItemKey(int keyCode);

    int getPickItemKey() throws NoSuchFieldException;

    void setPlayerListKey(int keyCode);

    int getPlayerListKey() throws NoSuchFieldException;

    void setCommandKey(int keyCode);

    int getCommandKey() throws NoSuchFieldException;
}