...
public class LauncherFiles {
    ...
    public static final String LWJGL_UTIL_JAR = MINEONLINE_LIBRARY_FOLDER + "org" + File.separator + "lwjgl" + File.separator + (OSUtils.isM1Mac() ? "lwjgl_util-mac-m1" : (OSUtils.isMac() ? "lwjgl_util-mac" : "lwjgl_util")) + File.separator + "2.9.3" + File.separator + (OSUtils.isM1Mac() ? "lwjgl_util-mac-m1-2.9.3.jar" : (OSUtils.isMac() ? "lwjgl_util-mac-2.9.3.jar" : "lwjgl_util-2.9.3.jar"));
