...
public class LauncherFiles {
    ...
    public static final String LWJGL_JAR = MINEONLINE_LIBRARY_FOLDER + "org" + File.separator + "lwjgl" + File.separator + (OSUtils.isM1JVM() ? "lwjgl-mac-m1" : (OSUtils.isMac() ? "lwjgl-mac" : "lwjgl")) + File.separator + (OSUtils.isM1JVM() ? "2.9.4" : "2.9.3") + File.separator + (OSUtils.isM1JVM() ? "lwjgl-mac-m1-2.9.4.jar" : (OSUtils.isMac() ? "lwjgl-mac-2.9.3.jar" : "lwjgl-2.9.3.jar"));
    public static final String LWJGL_UTIL_JAR = MINEONLINE_LIBRARY_FOLDER + "org" + File.separator + "lwjgl" + File.separator + (OSUtils.isM1JVM() ? "lwjgl_util-mac-m1" : (OSUtils.isMac() ? "lwjgl_util-mac" : "lwjgl_util")) + File.separator + (OSUtils.isM1JVM() ? "2.9.4" : "2.9.3") + File.separator + (OSUtils.isM1JVM() ? "lwjgl_util-mac-m1-2.9.4.jar" : (OSUtils.isMac() ? "lwjgl_util-mac-2.9.3.jar" : "lwjgl_util-2.9.3.jar"));
