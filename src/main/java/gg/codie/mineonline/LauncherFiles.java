...
public class LauncherFiles {
    ...
    public static final String AUTHLIB_JAR = MINEONLINE_LIBRARY_FOLDER + "com" + File.separator + "mojang" + File.separator + "authlib" + File.separator + "2.3.31" + File.separator + "authlib-2.3.31.jar";
