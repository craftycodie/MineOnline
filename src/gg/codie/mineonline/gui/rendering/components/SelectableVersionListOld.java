...
public class SelectableVersionListOld extends GUIObject {

    GUIObject scrollBarBackground;
    GUIObject scrollBar;
    GUIObject background;

    public SelectableVersionListOld(String name, Vector3f localPosition, Vector3f rotation, Vector3f scale) {
